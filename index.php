        ...
        <div class="content flexbox align reverse between">
            <div class="text">
                ...
                <ul style="list-style: initial; margin-left: var(--text-gap);">
                    ...
                    <li>salle d'eau</li>
                    <li>lit avec matelas à mémoires de forme</li>
    ...
    <section id="4" class="background">
        <div class="content grid center">
            <div class="title">
                ...
                <h3>Des lieux de rassemblement</h3>
            </div>
        ...
        <div class="content grid center">
            ...
            <div class="flexbox center align">
                <div class="card grid center">
                    ...
                    <p>Grace à la présence et la bienveillance d’un coordonnateur et d’une maitresse de maison, vous bénéficiez d’un accompagnement de proximité personnalisé, adapté à votre rythme, vos besoins.</p>
                </div>
                <div class="card grid center">
                    ...
                    <p>Se sentir bien et en sécurité avec ceux que l’on connait est nécessaire pour vivre en toute quiétude. C’est pourquoi l’accès à la villa est sécurisé. De plus, un dispositif d’alerte permet de contacter directement le coordonnateur en permanence.</p>
                </div>
                <div class="card grid center">
                    ...
                    <p>Connecté c’est unir, mettre une liaison entre un ou plusieurs éléments. En plus des activités proposées à la villa, vous serez également invité à participer aux activités socio-culturelles organisées dans la commune et plus largement du territoire. Et puis il y a aussi la connexion numérique, présente dans toute la villa.</p>
                </div>
            </div>
        </div>
    </section>
