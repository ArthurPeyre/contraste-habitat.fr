    ...
    <section id="4" class="background">
        <div class="content grid center">
            <div class="title">
                ...
                <h3>Des lieux qui rassembles</h3>
            </div>
        ...
        <div class="content grid center">
            ...
            <div class="flexbox center align">
                ...
                <div class="card grid center">
                    ...
                    <p>Connecté c’est unir, mettre une liaison entre un ou plusieurs éléments.<br>En plus des activités proposées à la villa, vous serez également invité à participer aux activités socio-culturelles organisées dans la commune et plus largement du territoire. Et puis il y a aussi la connexion numérique, présente dans toute la villa.</p>
                </div>
                <div class="card grid center">
